class ImageMovieResponseModel {
  List<Backdrops>? backdrops;
  int? id;
  List<Logos>? logos;
  List<Posters>? posters;

  ImageMovieResponseModel({this.backdrops, this.id, this.logos, this.posters});

  ImageMovieResponseModel.fromJson(Map<String, dynamic> json) {
