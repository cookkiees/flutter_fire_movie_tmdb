...
import 'controllers/just_release_movie_controller.dart';

class JustReleaseMovieViews extends GetView<JustReleaseMovieController> {
  const JustReleaseMovieViews({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Obx(
          () => controller.isLoadingJustReleaseMovie.value
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: GridView.builder(
                            itemCount: controller.justReleaseMovie.length,
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              var movie = controller.justReleaseMovie[index];
                              ...
                              return Padding(
                                ...
                                child: CustomMovieCardWidget(
                                  onTap: () {
                                    if (controller
                                        .justReleaseMovie.isNotEmpty) {
                                      Get.toNamed(
                                        '${AppRoutes.details}/${controller.justReleaseMovie[index].id}',
                                      );
                                    }
                                    details.refreshData();
                                  },
