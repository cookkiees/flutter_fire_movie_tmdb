...
class GenreComedyMovieViews extends GetView<GenreMovieController> {
  const GenreComedyMovieViews({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Obx(
          () => controller.isLoadingComedyMovie.value
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: GridView.builder(
                            itemCount: controller.comedyMovie.length,
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              var movie = controller.comedyMovie[index];

                              return Padding(
                                padding: const EdgeInsets.only(right: 16),
                                child: CustomMovieCardWidget(
                                  onTap: () {
                                    if (controller.comedyMovie.isNotEmpty) {
                                      Get.toNamed(
                                        '${AppRoutes.details}/${controller.comedyMovie[index].id}',
                                      );
                                    }
                                    details.refreshData();
                                  },
