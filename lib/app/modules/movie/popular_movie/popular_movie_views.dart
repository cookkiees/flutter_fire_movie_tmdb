...
class PopularMovieViews extends GetView<PopularMovieController> {
  const PopularMovieViews({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Obx(() {
          if (controller.isLoadingPopularMovie.value) {
            return const CupertinoActivityIndicator();
          } else {
            var popularMovie = controller.popularMovie;
            return SizedBox(
              height: 600,
              child: Stack(
                children: [
